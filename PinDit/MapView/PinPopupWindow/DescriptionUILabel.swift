...
class DescriptionUILabel: UILabel
{
    ...
    public func toggleView(anchorTo: TitleUITextField)
    {
        if(!toggled)
        {
            toggled = !toggled
            setMainViewAnchors(activeSetting: true, width: 0.4, height: 0.1, x: 0, y: 10, yAnchor: anchorTo.bottomAnchor, xAnchor: anchorTo.leftAnchor)
            return
        }
